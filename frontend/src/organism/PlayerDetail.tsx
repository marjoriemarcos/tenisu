...
export default function PlayerDetail (props: Readonly<PlayerProps>) {
    return (
        <div className="body_page">
                <img className="image-detail" src={props.picture} alt={`${props.firstname} ${props.lastname}`} />
